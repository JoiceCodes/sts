...
$getTotalNewCases = mysqli_prepare($connection, "SELECT COUNT(*) AS total_new_cases FROM cases WHERE case_status = ?");

$caseStatus = "New";
mysqli_stmt_bind_param($getTotalNewCases, "s", $caseStatus);
