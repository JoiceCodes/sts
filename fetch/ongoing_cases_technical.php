...
$getTotalOngoingCases = mysqli_prepare($connection, "SELECT COUNT(*) AS total_ongoing_cases FROM cases WHERE case_status = ? AND reopen = 0");

$caseStatus = "Waiting in Progress";
mysqli_stmt_bind_param($getTotalOngoingCases, "s", $caseStatus);
