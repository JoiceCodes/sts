                                ...
                                <table class="table" id="table">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($newCasesTable as $row) {
                                            ...
                                            $lastModified = htmlspecialchars($row["last_modified"]);
                                            $datetimeOpened = htmlspecialchars($row["datetime_opened"]);
            ...
            // --- Case Details Modal Logic ---
             ...
             if(caseDetailsModal) {
                ...
                $('#caseDetailsModal').on('show.bs.modal', function (event) {
                    ...
                    modal.find('#modalLastModified').text(caseData.lastModified || 'N/A');
                    modal.find('#modalDatetimeOpened').text(caseData.datetimeOpened || 'N/A');
