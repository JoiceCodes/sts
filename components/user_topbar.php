    ...
    <ul class="navbar-nav ml-auto">
                    ...
                    if ($chats_stmt) {
                        ...
                        if ($chats_result && $chats_result->num_rows > 0) {
                            ...
                            while ($chat_row = $chats_result->fetch_assoc()) {
                                ...
                                $chat_link = "../user/chat_view.php?case_number=" . urlencode($chat_row['case_number']);
        ...
        <li class="nav-item dropdown no-arrow">
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="../user/settings.php"> <i class="fas fa-cogs fa-sm fa-fw mr-2 text-gray-400"></i>Gmail Settings </a>
