                                ...
                                <div class="p-5">
                                    ...
                                    <?php if (isset($_GET["success"]) && $_GET["success"] === "1"): ?>
                                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                                            <i class="bi bi-check-circle-fill"></i> The OTP has been sent to your email address.
                                        </div>
                                    <?php elseif (isset($_GET["error"]) && $_GET["error"] === "1"): ?>
                                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                            <i class="bi bi-x-circle-fill"></i> Invalid OTP.
                                        </div>
                                    <?php endif; ?>

                                    <form class="user needs-validation" novalidate action="process/forgot_password_verify_otp.php" method="post">
